                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12">
                        ...
                        <div class="form-group">
                          <div class="input-group">
                            <span class="input-group-addon">Date from</span>
                            <input id="workStart" type="text" name="startDate" class="form-control" placeholder="e.g. 2012" value="<s:property value="%{workExperienceStartDate}"/>">

                              <span class="input-group-addon">Date to</span>
                            <input id="workEnd" type="text" name="endDate" class="form-control" placeholder="e.g. 2016" value="<s:property value="%{workExperienceEndDate}"/>">
                          </div>
                        </div>
